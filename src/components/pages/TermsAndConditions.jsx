...
const TermsAndConditions = ()=>{
    return(
        <div className="terms-conditions dummyPages">
        ...
        <div>
            ...
            <h5>If you feel that we are not abiding by this privacy policy, you should contact us immediately via telephone at XXX YYY-ZZZZ or via email.</h5>
        </div>
        </div>
    )
}
